...
def main():
    ...
    # data loader
    parser.add_argument('--data', type=str, default='ndelWTIalldata', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data_provider/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='ndelWTIalldata.csv', help='data file')
